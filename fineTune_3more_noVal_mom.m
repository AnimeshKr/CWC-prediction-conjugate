function [finalNN, trainError, testError, absTrainError, absTestError, minTestError] = fineTune_3more_noVal_mom( nn, sae1, sae2, sae3, origX1, origX2, origX3, origY, X1test, X2test, X3test, ytest, meanValues, mean1, predictionYear)
...
%     origX1 = origX1(pos,:);   origX2 = origX2(pos,:);  origX3 = origX3(pos,:);  origY = origY(pos,:);
    ...
    costFunc = @(p,inp1,inp2,inp3,out) costFunction_3more_2hid_do(p, ...
                                       input_layer1_size, ...
                                       input_layer2_size, ...
                                       input_layer3_size, ...
                                       hidden_layer11_size, ...
                                       ...
                                       hidden_layer13_size, ...
                                       hidden_layer2_size, ...
                                       num_labels, inp1, inp2, inp3, out, lambda, mean1, dropOutRatios);

    valcostFunc = @(p,inp1,inp2,inp3,out) valcostFunction_3more_2hid_do(p, ...
                                       input_layer1_size, ...
                                       input_layer2_size, ...
                                       input_layer3_size, ...
                                       hidden_layer11_size, ...
                                       ...
                                       hidden_layer13_size, ...
                                       hidden_layer2_size, ...
                                       num_labels, inp1, inp2, inp3, out, mean1, dropOutRatios);
    ...
    options.epochs = 100;
    options.plot = 1;
    nn_params = fminmom_fine_noLS(costFunc, valcostFunc, origX1, origX2, origX3, origY, X1test, X2test, X3test, ytest, initial_nn_params, options,  1, 0);
