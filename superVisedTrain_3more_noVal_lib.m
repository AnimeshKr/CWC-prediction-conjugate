function [nn, finalNN] = superVisedTrain_3more_noVal_lib(sae1, sae2, sae3)
...
%             curYearfeatures = curYearfeatures(pos,:);  curYearY = curYearY(pos,:);
            ...
            costFunc = @(p) costFunction_do(p, ...
                                               input_layer_size, ...
                                               hidden_layer_size, ...
                                               num_labels, curYearfeatures, curYearY, lambda, dropOutRatios);

            valcostFunc = @(p) valcostFunction_do(p, ...
                                               input_layer_size, ...
                                               hidden_layer_size, ...
                                               num_labels, featuresTest, ytest, dropOutRatios);
            ...
            [nn_params, ~] = fmincg(costFunc, nn_params, options, valcostFunc, 1);
